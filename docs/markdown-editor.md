...
- Inline code, URLs, standard links, and wiki links are Unicode bidi isolates. Code spans, URLs, list markers, task markers, and fenced code remain LTR; Arabic glyphs inside code fall back from JetBrains Mono to Rubik instead of an unspecified system face.
