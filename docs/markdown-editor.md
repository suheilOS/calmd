...
- Preview headings, paragraphs, list items, blockquotes, and table cells resolve direction separately. Preview code stays LTR. Logical padding, margins, borders, and text alignment mirror from each resolved content boundary.
