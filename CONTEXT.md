...
**Unlinked mention**:
A plain-text occurrence of the current note's visible title in another note body, outside supported internal links and Markdown code. Unlinked mentions stay hidden with backlinks until explicitly requested.
_Avoid_: Semantic match, suggested link
